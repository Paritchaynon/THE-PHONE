...
export type RelationshipDimKey = 
  | 'TRUST'
  | 'CLOSENESS'
  | 'CONFLICT'
  | 'UNDERSTANDING'
...
export type CoupleDynamicId =
  | 'THE_BALANCED_PAIR'
  | 'THE_CHASER_AND_THE_WALL'
  | 'THE_MIRROR_AND_THE_MIRROR'
  | 'THE_FIRE_AND_THE_WATER'
  | 'THE_GUARDIAN_AND_THE_SEEKER'
  | 'THE_ANCHOR_AND_THE_FREE_SOUL'
  | 'THE_HEALERS'
  | 'THE_STRANGERS';
...
export interface ChoiceDefinition {
  ...
  nextScene?: string; // direct jump or used in resolution
...
// Client View Types (Strict Isolation)
